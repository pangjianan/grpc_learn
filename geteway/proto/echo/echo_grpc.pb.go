...
func (c *echoClient) Say(ctx context.Context, in *SayRequest, opts ...grpc.CallOption) (*SayReply, error) {
	out := new(SayReply)
...
func (UnimplementedEchoServer) Say(context.Context, *SayRequest) (*SayReply, error) {
